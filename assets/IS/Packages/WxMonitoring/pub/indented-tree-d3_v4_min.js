...
(function (t, n) {
	...
	function T(t, n) {
		function e(e) {
			...
			e !== m && (b = b.transition(e), w = w.transition(e), k = k.transition(e), S = S.transition(e), T = T.transition(e).attr("opacity", Qs).attr("transform", function (t) {
		...
		return function (u) {
			...
			T = {
				...
				polygonEnd: function () {
					...
					e = b && n,
					i = (f = g(f)).length;
					(e || i) && (u.polygonStart(), e && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), i && Xr(f, a, n, o, u), u.polygonEnd()),
					w = u,
					f = l = h = null
				}
			};
			...
			if (c || (c = t = ee()), l < f && (s = l, l = f, f = s), l > e_)
				if (d > o_ - e_)
					...
					if (N > e_) {
						var A = Qa(N / f * t_(T)),
						C = Qa(N / l * t_(T));
						(w -= 2 * A) > e_ ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2),
