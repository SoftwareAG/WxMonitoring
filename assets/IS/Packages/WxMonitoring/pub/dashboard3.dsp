                                                    ...
                                                    <td colspan="6" class="keyrowdata"> 
                                                            <div id='dashboard'></div>
																	<script>
                                                                        ...
                                                                        var freqData=[
                                                                        {criteria:'AL',freq:{completed:4786, active:1319, failed:249,cancelled:249}}
                                                                        ,{criteria:'AZ',freq:{completed:1101, active:412, failed:674,cancelled:249}}
                                                                        ];

                                                                        createGraph('#dashboard',freqData,"process");
                                                                        </script>
